...
export const LoginDemoPage = () => {
  ...
  return (
    <div className="flex flex-col gap-5">
          ...
          <div className="mx-auto flex w-full max-w-sm flex-col gap-6">
            ...
            <form className="form-group" {...login.form}>
              <div className="form-field">
                ...
                <input placeholder="Type here" type="email" className={cn('input max-w-full', { 'input-error': login.get('login').errors?.email })} {...login.field('login')} />
      ...
      <code className="kbd block whitespace-pre overflow-x-scroll">{JSON.stringify(login.all, null, 4)}</code>
    </div>
  );
};
